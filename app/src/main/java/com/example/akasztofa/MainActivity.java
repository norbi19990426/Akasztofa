...
public class MainActivity extends AppCompatActivity {
    ...
    private void hiba(int korokFalse) {
        ...
        switch (korokFalse) {
            case 1:
                akasztofaImg.setImageResource(R.drawable.akasztofa01);
                break;
            case 2:
                akasztofaImg.setImageResource(R.drawable.akasztofa02);
                break;
            case 3:
                akasztofaImg.setImageResource(R.drawable.akasztofa03);
                break;
            case 4:
                akasztofaImg.setImageResource(R.drawable.akasztofa04);
                break;
            case 5:
                akasztofaImg.setImageResource(R.drawable.akasztofa05);
                break;
            case 6:
                akasztofaImg.setImageResource(R.drawable.akasztofa06);
                break;
            case 7:
                akasztofaImg.setImageResource(R.drawable.akasztofa07);
                break;
            case 8:
                akasztofaImg.setImageResource(R.drawable.akasztofa08);
                break;
            case 9:
                akasztofaImg.setImageResource(R.drawable.akasztofa09);
                break;
            case 10:
                akasztofaImg.setImageResource(R.drawable.akasztofa10);
                break;
            case 11:
                akasztofaImg.setImageResource(R.drawable.akasztofa11);
                break;
            case 12:
                akasztofaImg.setImageResource(R.drawable.akasztofa12);
                break;
            case 13:
                akasztofaImg.setImageResource(R.drawable.akasztofa13);
                break;
